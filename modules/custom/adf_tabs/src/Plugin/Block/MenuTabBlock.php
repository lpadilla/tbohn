...
namespace Drupal\adf_tabs\Plugin\Block;
...
use Drupal\adf_tabs\Plugin\Config\Block\MenuTabBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'MenuTabBlock' block.
 *
 * @Block(
 *  id = "adf_tabs.menu_tab_block",
 *  admin_label = @Translation("Menu Tabs"),
 * )
 */
class MenuTabBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var configurationInstance\Drupal\adf_tabs\Plugin\Config\Block\MenuTabBlockClass
   */
   ...
   * @param \Drupal\adf_tabs\Plugin\Config\Block\MenuTabBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, MenuTabBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('adf_tabs.menu_tab_block_class')
    );
  }
