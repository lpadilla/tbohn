...
use Drupal\tbo_account\Plugin\Config\AutocreateAccountBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'AutocreateAccountBlock' block.
 *
 * @Block(
 *  id = "autocreate_account_block",
 *  admin_label = @Translation("Autocreación de cuenta"),
 * )
 */
class AutocreateAccountBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_account\Plugin\Config\AutocreateAccountBlockClass
   */
   ...
   * @param \Drupal\tbo_account\Plugin\Config\AutocreateAccountBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, AutocreateAccountBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account.autocreate_account_block')
    );
  }
