...
use Drupal\tbo_account\Plugin\Config\CategoryServicesListBlockClass;
use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'CategoryServicesListBlock' block.
 *
 * @Block(
 *  id = "category_services_list_block",
 *  admin_label = @Translation("Category Services List"),
 * )
 */
class CategoryServicesListBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_account\Plugin\Config\CategoryServicesListBlockClass
   */
   ...
   * @param \Drupal\tbo_account\Plugin\Config\CategoryServicesListBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, CategoryServicesListBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account.category_services_list_block')
    );
  }
