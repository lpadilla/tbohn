...
use Drupal\tbo_account\Plugin\Config\Block\CompanyInvitedBlockClass;
use Drupal\tbo_general\CardBlockBase;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'CompanyInvitedBlock' block.
 *
 * @Block(
 *  id = "company_invited_block",
 *  admin_label = @Translation("Company Invited block"),
 * )
 */
class CompanyInvitedBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  
  
  /**
   * Instance configuration.
   *
   * @var \Drupal\tbo_account\Plugin\Config\Block\CompanyInvitedBlockClass
   */
  protected $configurationInstance;
  
  /**
   * Constructor 'CompanyInvitedBlock' block.
   *
   ...
   *   Block definition.
   * @param \Drupal\tbo_account\Plugin\Config\Block\CompanyInvitedBlockClass $configurationInstance
   *   Configuration class.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, CompanyInvitedBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account.company_invited_block_class')
    );
  }
