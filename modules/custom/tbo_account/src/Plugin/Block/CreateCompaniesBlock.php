...
/**
 * Provides a 'CreateCompaniesBlock' block.
 *
 * @Block(
 *  id = "companies_list_block",
 *  admin_label = @Translation("create company"),
 * )
 */
class CreateCompaniesBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var CreateCompaniesBlockClass
   */
   ...
   * @param \Drupal\tbo_account\Plugin\Config\Block\CreateCompaniesBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, CreateCompaniesBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account.create_companies_block')
    );
  }
