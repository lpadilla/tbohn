...
use Drupal\tbo_account\Plugin\Config\Block\CreateUserBlockClass;
use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'CreateUserBlock' block.
 *
 * @Block(
 *  id = "create_user_block",
 *  admin_label = @Translation("Create User"),
 * )
 */
class CreateUserBlock extends CardBlockBase implements ContainerFactoryPluginInterface {


  /**
   * @var CreateUserBlockClass
   */
   ...
   * @param \Drupal\tbo_account\Plugin\Config\Block\CreateUserBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, CreateUserBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account.create_user_block')
    );
  }
