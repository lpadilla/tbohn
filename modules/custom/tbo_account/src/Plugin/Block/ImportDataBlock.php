...
use Drupal\tbo_account\Plugin\Config\ImportDataBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'ImportDataBlock' block.
 *
 * @Block(
 *  id = "import_data_block_acounnt",
 *  admin_label = @Translation("Crear empresas masivamente"),
 * )
 */
class ImportDataBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_account\Plugin\Config\ImportDataBlockClass
   */
   ...
   * @param \Drupal\tbo_account\Plugin\Config\ImportDataBlockClass
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ImportDataBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account.import_data_block')
    );
  }
