...
use Drupal\tbo_account\Plugin\Config\ImportDataLogBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'ImportDataLogBlock' block.
 *
 * @Block(
 *  id = "import_data_log_block",
 *  admin_label = @Translation("Import data log block"),
 * )
 */
class ImportDataLogBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_account\Plugin\Config\ImportDataLogBlockClass
   */
   ...
   * @param \Drupal\tbo_account\Plugin\Config\ImportDataLogBlockClass
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ImportDataLogBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account.import_data_log_block')
    );
  }
