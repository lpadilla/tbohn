...
/**
 * Provides a 'ManageCompanyBlock' block.
 *
 * @Block(
 *  id = "manage_company_block",
 *  admin_label = @Translation("Manage companies"),
 * )
 */
class ManageCompanyBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * @var ManageCompanyBlockClass
   */
   ...
   * @param \Drupal\tbo_account\Plugin\Config\Block\ManageCompanyBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ManageCompanyBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account.manage_company_block')
    );
  }
