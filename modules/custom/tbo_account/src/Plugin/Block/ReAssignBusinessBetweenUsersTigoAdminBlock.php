...
/**
 * Provides a 'ReAssignBusinessBetweenUsersTigoAdminBlock' block.
 *
 * @Block(
 *  id = "re_assign_businesses_between_users_tigo_admin_block",
 *  admin_label = @Translation("Re-assign business between users tigo_admin"),
 * )
 */
class ReAssignBusinessBetweenUsersTigoAdminBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var ReAssignBusinessBetweenUsersTigoAdminBlockClass
   */
   ...
   * @param \Drupal\tbo_account\Plugin\Config\Block\ReAssignBusinessBetweenUsersTigoAdminBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ReAssignBusinessBetweenUsersTigoAdminBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account.re_assign_business_between_users_tigo_admin_block')
    );
  }
