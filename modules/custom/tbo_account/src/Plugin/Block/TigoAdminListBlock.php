...
use Drupal\tbo_account\Plugin\Config\Block\TigoAdminListBlockClass;
use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'TigoAdminListBlock' block.
 *
 * @Block(
 *  id = "Tigo_admin_list_block",
 *  admin_label = @Translation("Manage users tigo_admin"),
 * )
 */
class TigoAdminListBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var TigoAdminListBlockClass
   */
   ...
   * @param \Drupal\tbo_account\Plugin\Config\Block\TigoAdminListBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, TigoAdminListBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account.manage_users_tigo_admin_block')
    );
  }
