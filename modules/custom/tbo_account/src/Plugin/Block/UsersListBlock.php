...
/**
 * Provides a 'UsersListBlock' block.
 *
 * @Block(
 *  id = "users_list_block",
 ...
 * )
 */
class UsersListBlock extends CardBlockBase implements ContainerFactoryPluginInterface {


  /**
   * @var UserListBlockClass
   */
   ...
   * @param \Drupal\tbo_account\Plugin\Config\Block\UserListBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, UserListBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account.users_list_block')
    );
  }
