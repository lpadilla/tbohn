...
use Drupal\tbo_account\Plugin\Block\UsersListBlock;
use Drupal\Core\Session\AccountInterface;
use Drupal\Core\Access\AccessResult;
use Drupal\Core\Form\FormStateInterface;

/**
 * Manage config a 'UserListBlockClass' block.
 */
class UserListBlockClass {
  protected $instance;
  protected $configuration;

  /**
   * @param \Drupal\tbo_account\Plugin\Block\UsersListBlock $instance
   * @param $config
   */
  public function setConfig(UsersListBlock &$instance, &$config) {
  ...
  public function defaultConfiguration() {
    ...
    return [
      'filters_options' => [
        'filters_fields' => [
          'full_name' => ['title' => t('Nombres'), 'label' => 'Nombres', 'service_field' => 'full_name', 'show' => 1, 'weight' => 1, 'input_type' => 'text', 'class' => '3-columns', 'validate_length' => '300'],
          'mail' => ['title' => t('Correo'), 'label' => 'Correo', 'service_field' => 'mail', 'show' => 1, 'weight' => 2, 'input_type' => 'email', 'class' => '3-columns', 'validate_length' => '200'],
          'group_name' => ['title' => t('Grupo'), 'label' => 'Grupo', 'service_field' => 'group_name', 'show' => 1, 'weight' => 3, 'input_type' => 'text', 'class' => '3-columns', 'validate_length' => '130'],
          'document_number' => ['title' => t('Número de documento'), 'label' => 'Número de documento', 'service_field' => 'document_number', 'show' => 1, 'weight' => 4, 'input_type' => 'text', 'class' => '3-columns', 'validate_length' => '40'],
          'document_type' => ['title' => t('Tipo de documento'), 'label' => 'Tipo de documento', 'service_field' => 'document_type', 'show' => 1, 'weight' => 5, 'input_type' => 'text', 'type' => 'selectable', 'class' => '3-columns', 'none' => t('Ninguno')],
          'phone_number' => ['title' => t('Número de linea'), 'label' => 'Número de linea', 'service_field' => 'phone_number', 'show' => 1, 'weight' => 6, 'input_type' => 'text', 'class' => '3-columns', 'validate_length' => '20'],
          'user_role' => ['title' => t('Rol'), 'label' => 'Rol', 'service_field' => 'user_role', 'show' => 1, 'weight' => 7, 'input_type' => 'text', 'type' => 'selectable', 'class' => '3-columns', 'none' => t('Ninguno')],
          'company_name' => ['title' => t('Empresa'), 'label' => 'Empresa', 'service_field' => 'company_name', 'show' => 1, 'weight' => 8, 'input_type' => 'text', 'class' => '3-columns', 'validate_length' => '200'],
        ],
      ],
      'table_options' => [
        'table_fields' => [
          'full_name' => ['title' => t('Nombres'), 'label' => 'Nombres', 'type' => 'user', 'service_field' => 'full_name', 'show' => 1, 'weight' => 1],
          'mail' => ['title' => t('Correo'), 'label' => 'Correo', 'type' => 'user', 'service_field' => 'mail', 'show' => 1, 'weight' => 2],
          'group_name' => ['title' => t('Grupo'), 'label' => 'Grupo', 'type' => 'group', 'service_field' => 'group_name', 'show' => 1, 'weight' => 3],
          'document_number' => ['title' => t('Número de documento'), 'label' => 'Número de documento', 'type' => 'user', 'service_field' => 'document_number', 'show' => 1, 'weight' => 4],
          'document_type' => ['title' => t('Tipo de documento'), 'label' => 'Tipo de documento', 'type' => 'user', 'service_field' => 'document_type', 'show' => 1, 'weight' => 3],
          'phone_number' => ['title' => t('Número de linea'), 'label' => 'Número de linea', 'type' => 'user', 'service_field' => 'phone_number', 'show' => 1, 'weight' => 5],
          'user_role' => ['title' => t('Rol'), 'label' => 'Rol', 'type' => 'role', 'service_field' => 'user_role', 'show' => 1, 'weight' => 6],
          'company_name' => ['title' => t('Empresa'), 'label' => 'Empresa', 'type' => 'company', 'service_field' => 'company_name', 'show' => 1, 'weight' => 6],
        ],
      ],
      'others' => [
        'config' => [
   ...
   * {@inheritdoc}
   */
  public function build(UsersListBlock &$instance, &$config) {
    ...
    $parameters = [
      'theme' => 'users_list',
      'library' => 'tbo_account/users-list',
    ];
