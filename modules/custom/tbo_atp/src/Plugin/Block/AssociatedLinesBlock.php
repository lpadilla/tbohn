...
use Drupal\tbo_atp\Plugin\Config\Block\AssociatedLinesBlockClass;
use Drupal\tbo_general\CardBlockBase;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'AssociatedLinesBlock' block.
 *
 * @Block(
 *  id = "associated_lines_block",
 *  admin_label = @Translation("Associated Lines"),
 * )
 */
class AssociatedLinesBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * Configuration instance.
   *
   * @var \Drupal\tbo_atp\Plugin\Config\Block\AssociatedLinesBlockClass
   */
   ...
   * @param \Drupal\tbo_atp\Plugin\Config\Block\AssociatedLinesBlockClass $configurationInstance
   *   The configuration instance class.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, AssociatedLinesBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_atp.associated_lines_block_logic')
    );
  }
