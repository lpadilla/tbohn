...
use Drupal\tbo_atp\Plugin\Config\Block\AtpContractFilterBlockClass;
use Drupal\tbo_general\CardBlockBase;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'AtpContractFilterBlock' block.
 *
 * @Block(
 *  id = "atp_contrac_ftilter_block",
 *  admin_label = @Translation("Filtro plan corporativo por contrato"),
 * )
 */
class AtpContractFilterBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var $configurationInstance \Drupal\tbo_atp\Plugin\Config\Block\AtpContractFilterBlockClass
   */
   ...
   * @param AtpContractFilterBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, AtpContractFilterBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_atp.contract_filter_block_logic')
    );
  }
