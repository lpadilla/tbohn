...
use Drupal\tbo_atp\Plugin\Config\Block\AtpCorporativePlanSummaryBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'AtpCorporativePlanSummaryBlock' block.
 *
 * @Block(
 *  id = "atp_corporative_plan_summary_block",
 *  admin_label = @Translation("ATP Corporative Plan Summary block"),
 * )
 */
class AtpCorporativePlanSummaryBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var $configurationInstance \Drupal\tbo_atp\Plugin\Config\Block\AtpCorporativePlanSummaryBlockClass
   */
   ...
   * @param \Drupal\tbo_atp\Plugin\Config\Block\AtpCorporativePlanSummaryBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, AtpCorporativePlanSummaryBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_atp.atp_corporative_plan_summary_block')
    );
  }
