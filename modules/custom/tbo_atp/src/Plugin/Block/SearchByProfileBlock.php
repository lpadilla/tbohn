...
use Drupal\tbo_atp\Plugin\Config\Block\SearchByProfileBlockClass;
use Drupal\tbo_general\CardBlockBase;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'SearchByProfileBlock' block.
 *
 * @Block(
 *  id = "search_by_profile_block",
 *  admin_label = @Translation("Search By Profile"),
 * )
 */
class SearchByProfileBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * Configuration instance.
   *
   * @var \Drupal\tbo_atp\Plugin\Config\Block\SearchByProfileBlockClass
   */
   ...
   * @param \Drupal\tbo_atp\Plugin\Config\Block\SearchByProfileBlockClass $configurationInstance
   *   The configuration instance class.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, SearchByProfileBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_atp.search_profile_block_logic')
    );
  }
