...
use Drupal\tbo_billing\Plugin\Config\Block\AddCreditCardBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'AddCreditCardBlock' block.
 *
 * @Block(
 *  id = "add_credit_card_block",
 *  admin_label = @Translation("Adicionar tarjeta de crédito"),
 * )
 */
class AddCreditCardBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_billing\Plugin\Config\Block\AddCreditCardBlockClass
   */
   ...
   * @param \Drupal\tbo_billing\Plugin\Config\Block\AddCreditCardBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, AddCreditCardBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing.add_credit_card_block')
    );
  }
