...
/**
 * Provides a 'BillingSummaryBlock' block.
 *
 * @Block(
 *  id = "billing_summary_block",
 *  admin_label = @Translation("Resumen de facturación"),
 * )
 */
class BillingSummaryBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_billing\Plugin\Config\Block\BillingSummaryBlockClass
   */
   ...
   * @param \Drupal\tbo_billing\Plugin\Config\Block\BillingSummaryBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, BillingSummaryBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing.billing_summary_block_class')
    );
  }
