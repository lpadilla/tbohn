...
/**
 * Provides a 'CurrentInvoiceBlock' block.
 *
 * @Block(
 *  id = "current_invoice_block",
 *  admin_label = @Translation("Factura Actual"),
 * )
 */
class CurrentInvoiceBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, CurrentInvoiceBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing.current_invoice_block')
    );
  }
