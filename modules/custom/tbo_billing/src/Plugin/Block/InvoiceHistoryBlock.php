...
/**
 * Provides a 'InvoiceHistoryBlock' block..
 *
 * @Block(
 *  id = "invoice_history_block",
 *  admin_label = @Translation("Invoice history block"),
 * )
 */
class InvoiceHistoryBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * @var configurationInstance\Drupal\tbo_billing\Plugin\Config\Block\InvoiceHistoryBlockClass
   */
   ...
   * @param \Drupal\tbo_billing\Plugin\Config\Block\InvoiceHistoryBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, InvoiceHistoryBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing.invoice_history_block')
    );
  }
