...
use Drupal\tbo_billing\Plugin\Config\MultipleInvoicePaymentBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'MultipleInvoicePaymentBlock' block.
 *
 * @Block(
 *  id = "multiple_invoice_payment_block",
 *  admin_label = @Translation("Pago de múltiples facturas"),
 * )
 */
class MultipleInvoicePaymentBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_billing\Plugin\Config\CurrentInvoiceBlockClass
   */
   ...
   * @param \Drupal\tbo_billing\Plugin\Config\CurrentInvoiceBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, MultipleInvoicePaymentBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing.multiple_invoice_payment_block')
    );
  }
