...
use Drupal\tbo_billing\Plugin\Config\Block\PaymentDomiciliationBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'PaymentDomiciliationBlock' block.
 *
 * @Block(
 *  id = "payment_domiciliation_block",
 *  admin_label = @Translation("Domiciliación de pagos"),
 * )
 */
class PaymentDomiciliationBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_billing\Plugin\Config\Block\PaymentDomiciliationBlockClass
   */
   ...
   * @param \Drupal\tbo_billing\Plugin\Config\Block\PaymentDomiciliationBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, PaymentDomiciliationBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing.payment_domiciliation_block')
    );
  }
