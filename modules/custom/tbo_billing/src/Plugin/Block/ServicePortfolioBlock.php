...
/**
 * Provides a 'ServicePortfolioBlock' block.
 *
 * @Block(
 *  id = "service_portfolio_block",
 *  admin_label = @Translation("Portafolio de servicios"),
 * )
 */
class ServicePortfolioBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * @var \Drupal\tbo_billing\Plugin\Config\ServicePortfolioBlockClass
   */
   ...
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ServicePortfolioBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing.service_portfolio_block')
    );
  }
