 ...
 */
class SetUpInvoiceDeliveryBlockClass {
  ...
  /**
   * @param \Drupal\tbo_billing\Plugin\Block\SetUpInvoiceDeliveryBlock $instance
   * @param $config
   */
  ...
  public function defaultConfiguration() {
    return [
      ...
      'others' => [
        'config' => [
          'informative_text' => t('Reemplace su factura impresa por una versión electrónica y ayuda a conservar el medio ambiente'),
          'show_margin' => [
            'show_margin_card' => 1,
          ],
        ],
  ...
  public function build(SetUpInvoiceDeliveryBlock &$instance, &$config) {
    ...
    $modal = [
      'data' => $this->configuration['others_display']['table_fields'],
      'environment' => $_SESSION['environment'],
    ];

    $build = [
      '#theme' => 'set_up_invoice_delivery',
      ...
      '#angular_class' => 'set_up_invoice_delivery',
      '#attached' => [
        'library' => [
