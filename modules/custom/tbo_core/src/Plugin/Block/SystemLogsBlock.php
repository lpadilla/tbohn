...
namespace Drupal\tbo_core\Plugin\Block;
...
/**
 * Provides a 'SystemLogsBlock' block.
 *
 * @Block(
 *  id = "system_logs_block",
 *  admin_label = @Translation("List of logs"),
 * )
 */
class SystemLogsBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var SystemLogsBlockClass
   */
   ...
   * @param \Drupal\tbo_core\Plugin\Config\Block\SystemLogsBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, SystemLogsBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_core.system_logs_block')
    );
  }
