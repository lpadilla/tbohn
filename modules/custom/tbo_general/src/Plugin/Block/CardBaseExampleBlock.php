...
use Drupal\tbo_general\Plugin\Config\CardBaseExampleBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'CardBaseExampleBlock' block.
 *
 * @Block(
 *  id = "card_base_example_block",
 *  admin_label = @Translation("Card Base Example block"),
 * )
 */
class CardBaseExampleBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_general\Plugin\Config\CardBaseExampleBlockClass
   */
   ...
   * @param \Drupal\tbo_general\Plugin\Config\CardBaseExampleBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, CardBaseExampleBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_general.card_base_example_block')
    );
  }
