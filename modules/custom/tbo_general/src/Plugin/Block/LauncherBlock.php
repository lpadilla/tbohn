...
use Drupal\tbo_general\Plugin\Config\Block\LauncherBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'LauncherBlock' block.
 *
 * @Block(
 *  id = "tbo_general.launcher_block",
 *  admin_label = @Translation("Lanzador"),
 * )
 */
class LauncherBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_general\Plugin\Config\Block\LauncherBlockClass
   */
   ...
   * @param \Drupal\tbo_general\Plugin\Config\Block\LauncherBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, LauncherBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_general.launcher_block')
    );
  }
