...
use Drupal\tbo_general\Plugin\Config\Block\LogoCopySiteBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\user\PrivateTempStoreFactory;
/**
 * Provides a 'LogoCopySiteBlock' block.
 *
 * @Block(
 *  id = "logo_copy_site_block",
 *  admin_label = @Translation("Logo and Copyrigth for Site"),
 * )
 */
class LogoCopySiteBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_general\Plugin\Config\Block\LogoCopySiteBlockClass
   */
   ...
   * @param \Drupal\tbo_general\Plugin\Config\Block\LogoCopySiteBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, LogoCopySiteBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_general.logo_copy_site_block')
    );
  }
