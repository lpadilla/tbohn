...
/**
 * Provides a 'LogoTigoUneHeaderBlock' block.
 *
 * @Block(
 *  id = "logo_tigo_une_header_block",
 *  admin_label = @Translation("Logo Header B2B"),
 * )
 */
class LogoTigoUneHeaderBlock extends CardBlockBase {
