...
use Drupal\tbo_general\Plugin\Config\Block\SocialNetworksSiteBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\user\PrivateTempStoreFactory;
/**
 * Provides a 'SocialNetworksSiteBlock' block.
 *
 * @Block(
 *  id = "social_networks_site_block",
 *  admin_label = @Translation("Social Networks for Site"),
 * )
 */
class SocialNetworksSiteBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_general\Plugin\Config\Block\SocialNetworksSiteBlockClass
   */
   ...
   * @param \Drupal\tbo_general\Plugin\Config\Block\SocialNetworksSiteBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, SocialNetworksSiteBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_general.social_networks_site_block')
    );
  }
