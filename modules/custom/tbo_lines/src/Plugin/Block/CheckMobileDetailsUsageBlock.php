...
use Drupal\tbo_lines\Plugin\Config\Block\CheckMobileDetailsUsageBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'CheckMobileDetailsUsageBlock' block.
 *
 * @Block(
 *  id = "check_mobile_details_usage_block",
 *  admin_label = @Translation("Ckeck mobile details usage"),
 * )
 */
class CheckMobileDetailsUsageBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var $configurationInstance \Drupal\tbo_lines\Plugin\Config\Block\CheckMobileDetailsUsageBlockClass
   */
   ...
   * @param \Drupal\tbo_lines\Plugin\Config\Block\CheckMobileDetailsUsageBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, CheckMobileDetailsUsageBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_lines.check_mobile_details_usage_block')
    );
  }
