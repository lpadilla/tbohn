...
use Drupal\tbo_lines\Plugin\Config\Block\CheckMobileUsageBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'CheckMobileUsageBlock' block.
 *
 * @Block(
 *  id = "check_mobile_usage_block",
 *  admin_label = @Translation("Ckeck mobile usage"),
 * )
 */
class CheckMobileUsageBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  
  /**
   * @var $configurationInstance \Drupal\tbo_lines\Plugin\Config\Block\CheckMobileUsageBlockClass
   */
   ...
   * @param \Drupal\tbo_lines\Plugin\Config\Block\CheckMobileUsageBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, CheckMobileUsageBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_lines.check_mobile_usage_block')
    );
  }
