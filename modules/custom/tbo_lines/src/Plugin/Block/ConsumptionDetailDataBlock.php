...
use Drupal\tbo_lines\Plugin\Config\Block\ConsumptionDetailDataBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'ConsumptionDetailDataBlock' block.
 *
 * @Block(
 *  id = "consumption_detail_data_block",
 *  admin_label = @Translation("Detalle de consumo data"),
 * )
 */
class ConsumptionDetailDataBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var $configurationInstance \Drupal\tbo_lines\Plugin\Config\Block\ConsumptionDetailDataBlockClass
   */
   ...
   * @param \Drupal\tbo_lines\Plugin\Config\Block\ConsumptionDetailDataBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ConsumptionDetailDataBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_lines.consumption_detail_data_block_class')
    );
  }
