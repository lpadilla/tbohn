...
use Drupal\tbo_lines\Plugin\Config\Block\FixedConsumptionDailyBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'FixedConsumptionDailyBlock' block.
 *
 * @Block(
 *  id = "fixed_consumption_daily_block",
 *  admin_label = @Translation("Histórico de consumo fijo por día"),
 * )
 */
class FixedConsumptionDailyBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var $configurationInstance \Drupal\tbo_lines\Plugin\Config\Block\FixedConsumptionDailyBlockClass
   */
   ...
   * @param \Drupal\tbo_lines\Plugin\Config\Block\FixedConsumptionDailyBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, FixedConsumptionDailyBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_lines.fixed_consumption_daily_block_class')
    );
  }
