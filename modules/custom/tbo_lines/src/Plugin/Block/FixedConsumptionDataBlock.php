...
use Drupal\tbo_lines\Plugin\Config\Block\FixedConsumptionDataBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'FixedConsumptionDataBlock' block.
 *
 * @Block(
 *  id = "fixed_consumption_Data_block",
 *  admin_label = @Translation("Indicadores de Datos de consumo fijo"),
 * )
 */
class FixedConsumptionDataBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var $configurationInstance \Drupal\tbo_lines\Plugin\Config\Block\FixedConsumptionDataBlockClass
   */
   ...
   * @param \Drupal\tbo_lines\Plugin\Config\Block\FixedConsumptionDataBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, FixedConsumptionDataBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_lines.fixed_consumption_data_block_class')
    );
  }
