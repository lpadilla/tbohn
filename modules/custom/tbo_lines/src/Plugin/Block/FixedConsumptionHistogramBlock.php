...
use Drupal\tbo_lines\Plugin\Config\Block\FixedConsumptionHistogramBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'FixedConsumptionHistogramBlock' block.
 *
 * @Block(
 *  id = "fixed_consumption_histogram_block",
 *  admin_label = @Translation("Histograma de consumo fijo"),
 * )
 */
class FixedConsumptionHistogramBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var $configurationInstance \Drupal\tbo_lines\Plugin\Config\Block\FixedConsumptionHistogramBlockClass
   */
   ...
   * @param \Drupal\tbo_lines\Plugin\Config\Block\FixedConsumptionHistogramBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, FixedConsumptionHistogramBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_lines.fixed_consumption_histogram_block_class')
    );
  }
