...
namespace Drupal\tbo_lines\Plugin\Block;
...
use Drupal\tbo_lines\Plugin\Config\Block\HistoricalConsumptionPerMonthBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'HistoricalConsumptionPerMonthBlock' block.
 *
 * @Block(
 *  id = "historical_consumption_per_month_block",
 *  admin_label = @Translation("Histórico de consumo fijo por mes"),
 * )
 */
class HistoricalConsumptionPerMonthBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var $configurationInstance \Drupal\tbo_lines\Plugin\Config\Block\HistoricalConsumptionPerMonthBlockClass
   */
   ...
   * @param \Drupal\tbo_lines\Plugin\Config\Block\HistoricalConsumptionPerMonthBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, HistoricalConsumptionPerMonthBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_lines.historical_consumption_per_month_block_class')
    );
  }
