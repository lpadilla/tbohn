...
use Drupal\tbo_lines\Plugin\Config\Block\MobileCallHistoryBlockClass;

/**
 * Provides a 'MobileCallHistoryBlock' block.
 *
 * @Block(
 *  id = "mobile_call_history_block",
 *  admin_label = @Translation("Historial de consumos de voz"),
 * )
 */
class MobileCallHistoryBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var $configurationInstance  \Drupal\tbo_lines\Plugin\Config\Block\MobileCallHistoryBlockClass
   */
   ...
   * @param \Drupal\tbo_lines\Plugin\Config\Block\MobileCallHistoryBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, MobileCallHistoryBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_lines.mobile_call_history_block')
    );
  }
