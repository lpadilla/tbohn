...
use Drupal\tbo_lines\Plugin\Config\Block\MobileCallHistoryChartBlockClass;

/**
 * Provides a 'MobileCallHistoryChartBlock' block.
 *
 * @Block(
 *  id = "mobile_call_history_chart_block",
 *  admin_label = @Translation("Consumo de voz"),
 * )
 */
class MobileCallHistoryChartBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var $configurationInstance  \Drupal\tbo_lines\Plugin\Config\Block\MobileCallHistoryChartBlockClass
   */
   ...
   * @param \Drupal\tbo_lines\Plugin\Config\Block\MobileCallHistoryChartBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, MobileCallHistoryChartBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_lines.mobile_call_history_chart_block')
    );
  }
