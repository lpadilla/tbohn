...
use Drupal\tbo_lines\Plugin\Config\Block\SmsBalanceBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;


/**
 * Provides a 'SmsBalanceBlock' block.
 *
 * @Block(
 *  id = "sms_balance_block",
 *  admin_label = @Translation("Saldo SMS"),
 * )
 */
class SmsBalanceBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
	 ...
	 */
	public function __construct(array $configuration, $plugin_id, $plugin_definition, SmsBalanceBlockClass $configurationInstance) {
	...
	public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
		return new static(
			...
			$plugin_id,
			$plugin_definition,
			$container->get('tbo_lines.sms_balance_block_class')
		);
	}
