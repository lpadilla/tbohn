...
use Drupal\tbo_lines\Plugin\Config\Block\SmsConsumptionHistoryBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'SmsConsumptionHistoryBlock' block.
 *
 * @Block(
 *  id = "sms_consumption_history_block",
 *  admin_label = @Translation("Historico de consumos SMS"),
 * )
 */

class SmsConsumptionHistoryBlock extends CardBlockBase implements ContainerFactoryPluginInterface{
	
	
	/**
	 * @var $configurationInstance \Drupal\tbo_lines\Plugin\Config\Block\SmsBalanceBlockClass
	 */
	 ...
	 * @param \Drupal\tbo_lines\Plugin\Config\Block\SmsBalanceBlockClass $configurationInstance
	 */
	public function __construct(array $configuration, $plugin_id, $plugin_definition, SmsConsumptionHistoryBlockClass $configurationInstance) {
	...
	public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
		return new static(
			...
			$plugin_id,
			$plugin_definition,
			$container->get('tbo_lines.sms_consumption_history_block_class')
		);
	}
