...
class HistoricalConsumptionPerMonthRestLogic {
  ...
  /**
   * HistoricalConsumptionPerMonthRestLogic constructor.
   */
  ...
  public function get($parameters) {
    ...
    $contactId = '14326080';
    $line = '044974352'; // $_SESSION['serviceDetail']['address']
    $fromDate = '01-09-2017';
    $toDate = '11-09-2017';
    ...
    try {
      ...
      $response = $this->api->getLocalCallsByContractIdAndMeasuringElement($params)->response;
