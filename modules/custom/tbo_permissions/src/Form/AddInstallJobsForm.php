...
/**
 * Class AddInstallJobsForm.
 */
class AddInstallJobsForm extends ConfigFormBase {
  ...
  public function __construct() {
    $this->configForm = \Drupal::service('tbo_permissions.add_install_jobs_form_logic');
  ...
  protected function getEditableConfigNames() {
    return [
      'tbo_permissions.addinstalljobs',
    ];
  }
