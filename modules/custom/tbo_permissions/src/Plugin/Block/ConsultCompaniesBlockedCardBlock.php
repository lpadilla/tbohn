...
use Drupal\tbo_permissions\Plugin\Config\Block\ConsultCompaniesBlockedCardBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'ConsultCompaniesBlockedCard' block.
 *
 * @Block(
 *   id = "consult_companies_blocked_card",
 *   admin_label = @Translation("Consulta Listado de Empresas con Funcionalidad Bloqueada."),
 * )
 */
class ConsultCompaniesBlockedCardBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * Configuration instance.
   *
   * @var \Drupal\tbo_permissions\Plugin\Config\Block\ConsultCompaniesBlockedCardBlockClass
   */
   ...
   *   Plugin Definition.
   * @param \Drupal\tbo_permissions\Plugin\Config\Block\ConsultCompaniesBlockedCardBlockClass $configurationInstance
   *   Configuration instance.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ConsultCompaniesBlockedCardBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_permissions.consult_companies_blocked_card_block')
    );
  }
