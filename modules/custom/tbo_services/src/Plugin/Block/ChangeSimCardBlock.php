...
use Drupal\tbo_services\Plugin\Config\Block\ChangeSimCardBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'ChangeSimCard' block.
 *
 * @Block(
 *   id = "change_sim_card",
 *   admin_label = @Translation("Cambiar sim card"),
 * )
 */
class ChangeSimCardBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * @var \Drupal\tbo_services\Plugin\Config\Block\ChangeSimCardBlockClass
   */
   ...
   * @param \Drupal\tbo_services\Plugin\Config\Block\ChangeSimCardBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ChangeSimCardBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_services.change_sim_card_block_class')
    );
  }
