...
use Drupal\tbo_services\Plugin\Config\Block\ChangeWifiChannelBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'ChangeWifiChannel' block.
 *
 * @Block(
 *   id = "change_wifi_channel",
 *   admin_label = @Translation("Cambiar canal de la red wifi"),
 * )
 */
class ChangeWifiChannelBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * Object with the configuration.
   *
   * @var \Drupal\tbo_services\Plugin\Config\Block\ChangeWifiChannelBlockClass
   */
   ...
   *   Plugin definition.
   * @param \Drupal\tbo_services\Plugin\Config\Block\ChangeWifiChannelBlockClass $configurationInstance
   *   Configuration instance.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ChangeWifiChannelBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_services.change_wifi_channel_block')
    );
  }
