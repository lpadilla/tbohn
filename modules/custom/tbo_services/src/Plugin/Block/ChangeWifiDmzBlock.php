...
use Drupal\tbo_services\Plugin\Config\Block\ChangeWifiDmzBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'ChangeWifiDmzBlock' block.
 *
 * @Block(
 *   id = "change_wifi_dmz",
 *   admin_label = @Translation("Cambiar dmz de red wifi"),
 * )
 */
class ChangeWifiDmzBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
   ...
   *   Plugin_definition.
   * @param Drupal\tbo_services\Plugin\Config\Block\ChangeWifiDmzBlockClass $configurationInstance
   *   ConfigurationInstance.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ChangeWifiDmzBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_services.change_wifi_dmz_block_class')
    );
  }
