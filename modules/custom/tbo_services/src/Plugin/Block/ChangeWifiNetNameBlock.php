...
use Drupal\tbo_services\Plugin\Config\Block\ChangeWifiNetNameBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'ChangeWifiNetNameBlock' block.
 *
 * @Block(
 *   id = "change_wifi_net_name",
 *   admin_label = @Translation("Cambiar nombre de red wifi"),
 * )
 */
class ChangeWifiNetNameBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * @var \Drupal\tbo_services\Plugin\Config\Block\ChangeWifiNetNameBlockClass
   */
   ...
   * @param \Drupal\tbo_services\Plugin\Config\Block\ChangeWifiNetNameBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ChangeWifiNetNameBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_services.change_wifi_net_name_block_class')
    );
  }
