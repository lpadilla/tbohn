...
use Drupal\tbo_services\Plugin\Config\Block\DetalleVerProductoFijoBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'DetalleVerProductoFijo' block.
 *
 * @Block(
 *   id = "detalle_ver_producto_fijo",
 *   admin_label = @Translation("Detalle Ver Producto Fijo"),
 * )
 */
class DetalleVerProductoFijoBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * @var $configurationInstance \Drupal\tbo_services\Plugin\Config\Block\DetalleVerProductoFijoBlockClass
   */
   ...
   * @param DetalleVerProductoFijoBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, DetalleVerProductoFijoBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_services.detalle_ver_producto_fijo_block')
    );
  }
