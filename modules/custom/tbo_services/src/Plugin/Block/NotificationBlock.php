...
use Drupal\tbo_services\Plugin\Config\Block\NotificationBlockClass;
 ...
 * )
 */
class NotificationBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * Configuration instance.
   *
   * @var \Drupal\tbo_services\Plugin\Config\Block\NotificationBlockClass
   */
   ...
   * @param \Drupal\tbo_services\Plugin\Config\Block\NotificationBlockClass $configurationInstance
   *   The configuration instance class.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, NotificationBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_services.notification_logic_block')
    );
  }
