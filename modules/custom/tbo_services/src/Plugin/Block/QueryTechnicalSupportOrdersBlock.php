...
use Drupal\tbo_services\Plugin\Config\Block\QueryTechnicalSupportOrdersBlockClass;
use Drupal\tbo_general\CardBlockBase;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'QueryTechnicalSupportOrdersBlock' block.
 *
 * @Block(
 *  id = "query_technical_support_orders_block",
 *  admin_label = @Translation("Consult Technical Support Orders"),
 * )
 */
class QueryTechnicalSupportOrdersBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * Configuration instance.
   *
   * @var \Drupal\tbo_services\Plugin\Config\Block\QueryTechnicalSupportOrdersBlockClass
   */
   ...
   * @param \Drupal\tbo_services\Plugin\Config\Block\QueryTechnicalSupportOrdersBlockClass $configurationInstance
   *   The configuration instance class.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, QueryTechnicalSupportOrdersBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_services.query_technical_support_logic_block')
    );
  }
