...
use Drupal\tbo_services\Plugin\Config\Block\ReturnBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'Return' block.
 *
 * @Block(
 *   id = "Return block",
 *   admin_label = @Translation("Bloque retornar"),
 * )
 */
class ReturnBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * @var \Drupal\tbo_services\Plugin\Config\Block\ReturnBlockClass
   */
   ...
   * @param \Drupal\tbo_services\Plugin\Config\Block\ReturnBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ReturnBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    $plugin_id,
    $plugin_definition,
    $container->get('tbo_services.return_block_class')
    );
  }
