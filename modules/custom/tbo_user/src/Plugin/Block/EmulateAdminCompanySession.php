...
namespace Drupal\tbo_user\Plugin\Block;

use Drupal\Core\Form\FormStateInterface;
use Drupal\Core\Session\AccountInterface;
use Drupal\tbo_general\CardBlockBase;
use Drupal\tbo_user\Plugin\Config\Block\EmulateAdminCompanySessionBlockClass;
 ...
 *
 * @Block(
 *  id = "emulate_admin_company_session",
 *  admin_label = @Translation("Emulate Admin Company Session"),
 * )
 */
class EmulateAdminCompanySession extends CardBlockBase implements ContainerFactoryPluginInterface {
   ...
   * @param \Drupal\tbo_user\Plugin\Config\Block\EmulateAdminCompanySessionBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, EmulateAdminCompanySessionBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_user.emulate_admin_company_session_block')
    );
  }
