...
use Drupal\tbo_user\Plugin\Config\Block\UnmasqueradeBlockClass;
 ...
 *
 * @Block(
 *  id = "unmasquerade_block",
 *  admin_label = @Translation("Desenmascarar sesion"),
 * )
 */
class UnmasqueradeBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
   ...
   * @param \Drupal\tbo_user\Plugin\Config\Block\UnmasqueradeBlockClass $configurationInstance
   */
