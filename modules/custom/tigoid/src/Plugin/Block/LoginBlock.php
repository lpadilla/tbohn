...
namespace Drupal\tigoid\Plugin\Block;

use Drupal\tbo_general\CardBlockBase;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Drupal\Core\Form\FormStateInterface;
use Drupal\tigoid\Plugin\Config\Block\LoginBlockClass;
 ...
 * @Block(
 *  id = "login_block",
 *  admin_label = @Translation("Login TigoID"),
 * )
 */
class LoginBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * Configuration instance.
   *
   * @var \Drupal\tigoid\Plugin\Config\Block\LoginBlockClass
   */
   ...
   *   Block definition.
   * @param \Drupal\tigoid\Plugin\Config\Block\LoginBlockClass $configurationInstance
   *   Instance.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, LoginBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tigoid.login_block_class')
    );
  }
