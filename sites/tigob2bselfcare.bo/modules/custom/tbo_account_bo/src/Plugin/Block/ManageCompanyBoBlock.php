...
use Drupal\tbo_account_bo\Plugin\Config\Block\ManageCompanyBoBlockClass;

/**
 * Provides a 'ManageCompanyBoBlock' block.
 *
 * @Block(
 *  id = "manage_company_bo_block",
 *  admin_label = @Translation("Administrar Empresas Bo"),
 * )
 */


class ManageCompanyBoBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * @var $configurationInstance ManageCompanyBoBlockClass
   */
   ...
   * @param ManageCompanyBoBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ManageCompanyBoBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account_bo.manage_company_bo_block')
    );
  }
