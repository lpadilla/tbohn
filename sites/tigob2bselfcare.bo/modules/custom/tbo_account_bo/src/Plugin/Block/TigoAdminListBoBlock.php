...
use Drupal\tbo_account_bo\Plugin\Config\Block\TigoAdminListBoBlockClass;
use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'TigoAdminListBoBlock' block.
 *
 * @Block(
 *  id = "Tigo_admin_list_bo_block",
 *  admin_label = @Translation("Usuarios Tigo Admin"),
 * )
 */
class TigoAdminListBoBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

	/**
   * @var $configurationInstance TigoAdminListBoBlockClass
   */
   ...
   * @param TigoAdminListBoBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, TigoAdminListBoBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account_bo.manage_users_tigo_admin_bo_block')
    );
  }
