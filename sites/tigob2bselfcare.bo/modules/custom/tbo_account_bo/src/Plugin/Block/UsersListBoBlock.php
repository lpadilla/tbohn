...
use Drupal\tbo_account_bo\Plugin\Config\Block\UserListBoBlockClass;
use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'UsersListBoBlock' block.
 *
 * @Block(
 *  id = "users_list_bo_block",
 *  admin_label = @Translation("Listado de Usuarios para BO"),
 * )
 */
class UsersListBoBlock extends CardBlockBase implements ContainerFactoryPluginInterface {


  /**
   * @var UserListBoBlockClass
   */
   ...
   * @param \Drupal\tbo_account_bo\Plugin\Config\Block\UserListBoBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, UserListBoBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account_bo.users_list_bo_block')
    );
  }
