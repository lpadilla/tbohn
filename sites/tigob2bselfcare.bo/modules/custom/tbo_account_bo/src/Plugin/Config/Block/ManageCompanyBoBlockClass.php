...
use Drupal\tbo_account_bo\Plugin\Block\ManageCompanyBoBlock;
...
/**
 * Manage config a 'ManageCompanyBoBlockClass' block.
 */
class ManageCompanyBoBlockClass extends ManageCompanyBlockClass {
  protected $instance;
  protected $configuration;

  /**
   * @param ManageCompanyBoBlock $instance
   * @param $config
   */
  public function setConfig(ManageCompanyBoBlock &$instance, &$config) {
  ...
  public function defaultConfiguration() {
    return [
      'filters_options' => [
        'filters_fields' => [
          'document_number' => [
            'title' => t('NIT/Número de documento'),
   ...
   * {@inheritdoc}
   */
  public function build(ManageCompanyBoBlock &$instance, &$config) {
    ...
    $parameters = [
      'theme' => 'manage_company_bo',
      'library' => 'tbo_account_bo/companies-manage-bo',
    ];
