...
namespace Drupal\tbo_account_bo\Services\Rest;
...
/**
 * Class CreateCompaniesRestServiceBo.
 *
 * @package Drupal\tbo_account_bo\Services\Rest
 */
class CreateCompaniesRestServiceBo {
  ...
  public function get(AccountProxyInterface $currentUser) {
    ...
    $account_bo_repository = \Drupal::service('tbo_account_bo.repository');
    ...
    try {
      ...
      $data = $account_bo_repository->getQueryCompaniesBo($filters, $columns_table, $config_paginate, $others_field);
