...
namespace Drupal\tbo_balance_bo\Plugin\Block;
...
use Drupal\tbo_balance_bo\Plugin\Config\Block\BalancesBoBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'BalancesBlock' block.
 *
 * @Block(
 *  id = "balances_bo_block",
 *  admin_label = @Translation("Saldos"),
 * )
 */
class BalancesBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * @var $configurationInstance BalancesBoBlockClass
   */
   ...
   * @param BalancesBoBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, BalancesBoBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_balance_bo.balance_bo_block')
    );
  }
