...
use Drupal\tbo_billing_bo\Plugin\Config\Block\ContractsBoBlockClass;
use Drupal\tbo_general\CardBlockBase;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'ContractsBoBlock' block.
 *
 * @Block(
 *  id = "contracts_bo_block",
 *  admin_label = @Translation("Lista de contratos"),
 * )
 */
class ContractsBoBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_billing_bo\Plugin\Config\Block\ContractsBoBlockClass
   */
   ...
   * @param \Drupal\tbo_billing_bo\Plugin\Config\Block\ContractsBoBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ContractsBoBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing_bo.contracts_bo_block_class')
    );
  }
