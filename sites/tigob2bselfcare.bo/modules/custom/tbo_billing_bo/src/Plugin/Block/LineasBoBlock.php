...
use Drupal\tbo_billing_bo\Plugin\Config\Block\LineasBoBlockClass;
use Drupal\tbo_general\CardBlockBase;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'LineasBoBlock' block.
 *
 * @Block(
 *  id = "lineas_bo_block",
 *  admin_label = @Translation("Lineas Bo block"),
 * )
 */
class LineasBoBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * @var \Drupal\tbo_billing_bo\Plugin\Config\Block\LineasBoBlockClass
   */
   ...
   * @param \Drupal\tbo_billing_bo\Plugin\Config\Block\LineasBoBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, LineasBoBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing_bo.lineas_bo_block_class')
    );
  }
