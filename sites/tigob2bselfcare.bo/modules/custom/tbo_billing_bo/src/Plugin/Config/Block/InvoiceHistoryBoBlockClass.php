...
/**
 * Manage config a 'InvoiceHistoryBoBlockClass' block.
 */
class InvoiceHistoryBoBlockClass extends InvoiceHistoryBlockClass {
  ...
  public function defaultConfiguration() {
    return array(
      'table_options' => [
        'table_fields' => [
          'period' => ['title' => 'Periodo', 'label' => t('Periodo'), 'service_field' => 'period', 'show' => 1, 'weight' => 1,],
          'invoiceId' => ['title' => 'Número de factura', 'label' => t('Número de factura'), 'service_field' => 'invoiceId', 'show' => 1, 'weight' => 1,],
          'contractId' => ['title' => 'Contrato', 'label' => t('Contrato'), 'service_field' => 'contractId', 'show' => 1, 'weight' => 1,],
          ...
          'options' => ['title' => 'Descargar', 'label' => t('Descargar'), 'service_field' => 'options', 'show' => 1, 'weight' => 5,],
        ],
      ],  
      'others' => [
        'config' => [
  ...
  public function build(InvoiceHistoryBlock &$instance, &$config) {
    ...
    $config_block = $this->instance->cardBuildConfigBlock('tboapi/billing/history/bo?_format=json', $others);
