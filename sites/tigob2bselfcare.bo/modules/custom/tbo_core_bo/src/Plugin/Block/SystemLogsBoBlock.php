...
namespace Drupal\tbo_core_bo\Plugin\Block;

use Drupal\Core\Form\FormStateInterface;
use Drupal\Core\Session\AccountInterface;
use Drupal\tbo_general\CardBlockBase;
use Drupal\tbo_core_bo\Plugin\Config\Block\SystemLogsBoBlockClass;
use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'SystemLogsBoBlock' block.
 *
 * @Block(
 *  id = "system_logs_block_bo",
 *  admin_label = @Translation("List of logs of BO"),
 * )
 */
class SystemLogsBoBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var configurationInstanceSystemLogsBlockClass
   */
   ...
   * @param \Drupal\tbo_core_bo\Plugin\Config\Block\SystemLogsBoBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, SystemLogsBoBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_core_bo.system_logs_block_bo')
    );
  }
