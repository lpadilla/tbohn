...
/**
 * Provides a 'CompanySelectorBoBlock' block.
 *
 * @Block(
 *  id = "company_selector_block_bo",
 *  admin_label = @Translation("Company selector block Bo"),
 * )
 */
class CompanySelectorBoBlock extends BlockBase {
  ...
  public function build() {
    ...
    $build['#theme'] = 'company_selector_bo';

    $build['#attached'] = array(
        'library' => array(
          'tbo_emulate_bo/company-selector'
        ),
      );
