...
use Drupal\tbo_emulate_bo\Plugin\Config\Block\EmulateAdminCompanySessionBoBlockClass;
use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'EmulateAdminCompanySessionBo' block.
 *
 * @Block(
 *  id = "emulate_admin_company_session_bo",
 *  admin_label = @Translation("Emulate Admin Company Session BO"),
 * )
 */
class EmulateAdminCompanySessionBo extends CardBlockBase implements ContainerFactoryPluginInterface {
   ...
   * @param \Drupal\tbo_emulate_bo\Plugin\Config\Block\EmulateAdminCompanySessionBoBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, EmulateAdminCompanySessionBoBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_emulate_bo.emulate_admin_company_session_bo_block')
    );
  }
