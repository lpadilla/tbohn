...
namespace Drupal\tbo_emulate_bo\Plugin\rest\resource;
 ...
 *
 * @RestResource(
 *   id = "emulate_session_rest_resource_bo",
 *   label = @Translation("Emulate Session Rest Resource BO"),
 *   uri_paths = {
 *     "canonical" = "/tboapi/emulate/bo/session"
 *   }
 * )
 */
class EmulateSessionBoRestResource extends ResourceBase {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('logger.factory')->get('tbo_emulate_bo'),
  ...
  public function get() {
    ...
    // Get repository.
    $account_repository = \Drupal::service('tbo_account_bo.repository');
