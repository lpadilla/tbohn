...
/**
 * Provides a 'LogoTigoUneFooterBoBlock' block.
 *
 * @Block(
 *  id = "logo_tigo_une_footer_bo_block",
 *  admin_label = @Translation("Logo Footer B2B Bo"),
 * )
 */
class LogoTigoUneFooterBoBlock extends CardBlockBase  {
