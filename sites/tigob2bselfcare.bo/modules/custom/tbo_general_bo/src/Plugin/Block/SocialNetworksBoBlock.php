...
namespace Drupal\tbo_general_bo\Plugin\Block;
...
/**
 * Provides a 'SocialNetworksBoBlock' block.
 *
 * @Block(
 *  id = "social_networks_bo_block",
 *  admin_label = @Translation("Redes sociales Bo"),
 * )
 */
class SocialNetworksBoBlock extends CardBlockBase {
  ...
  public function build() {
    ...
    $parameters = [
      ...
      'library' => 'tbo_general_bo/general-social',
    ];
