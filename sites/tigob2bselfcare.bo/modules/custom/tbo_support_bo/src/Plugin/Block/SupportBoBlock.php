...
namespace Drupal\tbo_support_bo\Plugin\Block;
...
use Drupal\tbo_support_bo\Plugin\Config\Block\SupportBoBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'SupportBoBlock' block.
 *
 * @Block(
 *  id = "support_test_bo_block",
 *  admin_label = @Translation("Agentes de soporte"),
 * )
 */
class SupportBoBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
	/**
   * @var $configurationInstance SupportBoBlockClass
   */
   ...
   * @param SupportBoBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, SupportBoBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_support_bo.support_bo_block')
    );
  }
