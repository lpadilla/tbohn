    ...
    $(this).each(function(){
      ...
      var appendOptionWithIcon = function(select, option, type) {
        ...
        if (!!icon_url) {
          ...
          if (type === 'multiple') {
            options.append($('<li class="' + disabledClass + '"' + placeholderString + '><img src="' + icon_url + '"' + classString + '><span><input class="filled-in" type="checkbox"' + disabledClass + '/><label></label>' + optionContent + '</span></li>'));
          } else {
        ...
        // Check for multiple type.
        if (type === 'multiple') {
          options.append($('<li li class="' + disabledClass + '"' + placeholderString + '><span><input class="filled-in" type="checkbox"' + disabledClass + '/><label></label>' + optionContent + '</span></li>'));
        } else {
