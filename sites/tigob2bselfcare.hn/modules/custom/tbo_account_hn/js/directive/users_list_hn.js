...
function UsersListController($scope, $http) {
	...
	jQuery("#tagsList").click(function(){ 				
		$('.row').css('max-height', '750px'); //set max height			
     });
	...
	jQuery('.click-filter-reset').click(function () {
		...
		if (jQuery('.Tipo label').hasClass('active')) {              
		  ...
		  if (jQuery('.Documento label').hasClass('active')) {              
			jQuery('.Documento label').removeClass('active');       
		  }
		  if (jQuery('.Rol label').hasClass('active')) {              
			jQuery('.Rol label').removeClass('active');       
		  }   
		  
		  if (jQuery('.form-type-select label').hasClass('active')) {              
			jQuery('.form-type-select label').removeClass('active');      
			
		  } 

        if (jQuery('.form-item-user label').hasClass('active')) {              
          jQuery('.form-item-user label').removeClass('active').addClass('');      
