...
use Drupal\tbo_account_hn\Plugin\Config\Block\ManageCompanyHnBlockClass;


/**
 * Provides a 'ManageCompanyHnBlock' block.
 *
 * @Block(
 *  id = "manage_company_hn_block",
 *  admin_label = @Translation("Administrar Empresas HN"),
 * )
 */


class ManageCompanyHnBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  /**
   * @var configurationInstance ManageCompanyHnBlockClass
   */
   ...
   * @param ManageCompanyHnBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ManageCompanyHnBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
     	$container->get('tbo_account_hn.manage_company_hn_block')
    );
  }
  ...
  protected function getEditableConfigNames() {
    if (method_exists($this->configurationInstance,'getEditableConfigNames')) {
      return $this->configurationInstance->getEditableConfigNames();
    }
