...
use Drupal\tbo_account_hn\Plugin\Config\Block\ReAssignBusinessBetweenUsersTigoAdminHnBlockClass;


/**
 * Provides a 'ReAssignBusinessBetweenUsersTigoAdminHnBlock' block.
 *
 * @Block(
 *  id = "re_assign_business_between_users_tigo_admin_block_hn",
 *  admin_label = @Translation("Re-assign business between users tigo_admin HN"),
 * )
 */
class ReAssignBusinessBetweenUsersTigoAdminHnBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
  
/**
   * @var $configurationInstance ReAssignBusinessBetweenUsersTigoAdminHnBlockClass
   */
   ...
   * @param ReAssignBusinessBetweenUsersTigoAdminHnBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ReAssignBusinessBetweenUsersTigoAdminHnBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account_hn.re_assign_business_between_users_tigo_admin_block_hn')
    );
  }
