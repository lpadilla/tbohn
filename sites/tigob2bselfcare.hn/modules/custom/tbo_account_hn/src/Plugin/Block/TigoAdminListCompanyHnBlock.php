...
/**
 * Provides a 'TigoAdminListCompanyHnBlock' block.
 *
 * @Block(
 *  id = "tigo_admin_list_company_hn_block",
 *  admin_label = @Translation("Listado Empresas Tigo Admin HN"),
 * )
 */
class TigoAdminListCompanyHnBlock extends TigoAdminListCompanyBlock {
  ...
  public function build()
  {
    ...
    $build = array(
      '#theme' => 'tigo_admin_list_companies_hn',
      '#uuid' => $uuid,
      '#filters' => $filters,
      '#headers_table' => $headers_table,
      '#attached' => array(
        'library' => array(
          'tbo_account_hn/tigo-admin-list-companies-hn',
        ),
      ),
    );
