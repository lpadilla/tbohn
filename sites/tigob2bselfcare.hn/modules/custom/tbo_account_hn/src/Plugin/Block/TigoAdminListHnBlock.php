...
use Drupal\tbo_account_hn\Plugin\Config\Block\TigoAdminListHnBlockClass;
use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'TigoAdminListHnBlock' block.
 *
 * @Block(
 *  id = "Tigo_admin_list_hn_block",
 *  admin_label = @Translation("Usuarios Tigo Admin"),
 * )
 */
class TigoAdminListHnBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

	/**
   * @var $configurationInstance TigoAdminListHnBlockClass
   */
   ...
   * @param TigoAdminListHnBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, TigoAdminListHnBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_account_hn.manage_users_tigo_admin_hn_block')
    );
  }
