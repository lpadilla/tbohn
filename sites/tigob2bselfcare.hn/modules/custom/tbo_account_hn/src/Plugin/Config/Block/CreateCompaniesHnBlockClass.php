...
use Drupal\tbo_account_hn\Plugin\Block\CreateCompaniesHnBlock;
 ...
 */
class CreateCompaniesHnBlockClass extends CreateCompaniesBlockClass {
  protected $instance;
  protected $configuration;

  /**
   * @param CreateCompaniesHnBlock $instance
   * @param $config
   */
  public function setConfig(CreateCompaniesHnBlock &$instance, &$config) {
  ...
  public function build() {
   ...
   $this->instance->ordering('table_fields', 'table_options');//NEW
    ...
    //Get form enterprise
    $form = $this->instance->cardBuildGetForm('\Drupal\tbo_account_hn\Form\CreateCompanyForm');

    //Se construye la variable $build con los datos que se necesitan en el tema
    $parameters = [
      'theme' => 'companies_list_hn',
      'library' => 'tbo_account_hn/companies-list-hn',
    ...
    $others = [
      ...
      '#title' => $title,
      //'#margin' => $this->configuration['others']['show_margin'],//OLD
      '#margin' => $this->configuration['others']['config']['show_margin'],//NEW
