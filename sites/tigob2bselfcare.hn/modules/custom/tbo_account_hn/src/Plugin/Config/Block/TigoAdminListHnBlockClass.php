...
use Drupal\tbo_account_hn\Plugin\Block\TigoAdminListHnBlock;
use Drupal\Core\Session\AccountInterface;
use Drupal\Core\Access\AccessResult;
use Drupal\Core\Form\FormStateInterface;

/**
 * Manage config a 'TigoAdminListHnBlockClass' block.
 */
class TigoAdminListHnBlockClass {
  protected $instance;
   ...
   * @param $config
   */
  public function setConfig(TigoAdminListHnBlock &$instance, &$config) {
    ...
    return array(
      ...
      'table_options' => [
        'table_fields' => [
          ...
          'status' => ['title' => t('Activo'), 'label' => t('Activo'), 'type' => 'user', 'service_field' => 'status', 'show' => 1, 'weight' => 4,],
          'assign_enterprise' => ['title' => t('Reasignar'), 'label' => t('Reasignar'), 'type' => 'company', 'service_field' => 'assign_enterprise', 'show' => 1, 'weight' => 6,],
        ],
      ],
      'others' => [
        'config' => [
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    $field['url_config'] = array(
      ...
      //'#default_value' => $this->configuration['others']['url_config'],
