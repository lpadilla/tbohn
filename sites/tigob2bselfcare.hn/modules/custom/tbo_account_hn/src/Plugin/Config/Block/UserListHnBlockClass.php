...
use Drupal\tbo_account_hn\Plugin\Block\UsersListHnBlock;
...
/**
 * Manage config a 'UserListHnBlockClass' block.
 */
class UserListHnBlockClass extends UserListBlockClass {
  protected $instance;
  protected $configuration;

  /**
   * @param \Drupal\tbo_account_hn\Plugin\Block\UsersListHnBlock $instance
   * @param $config
   */
  public function setConfig(UsersListHnBlock &$instance, &$config) {
    ...
    return [
      'filters_options' => [
        'filters_fields' => [
          ...
          'document_number' => ['title' => t(''), 'label' => 'Número', 'service_field' => 'document_number', 'show' => 1, 'weight' => 3, 'input_type' => 'text', 'class' => '3-columns', 'validate_length' => '40'],
   ...
   * {@inheritdoc}
   */
  public function build(UsersListHnBlock &$instance, &$config) {
    ...
    unset($roles['admin_group']); //RVS 20180207
    ...
    $parameters = [
      'theme' => 'users_list_hn',
      'library' => 'tbo_account_hn/users-list-hn',
    ];
