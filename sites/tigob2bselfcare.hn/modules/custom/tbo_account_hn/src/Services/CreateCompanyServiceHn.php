 ...
 */
class CreateCompanyServiceHn extends CreateEnterpriseService{
...
*/
  ...
  public function _createCompany($company_data) {
    ...
    $company = CompanyEntityHn::create($company_data);
    $company->save();
  }
