...
namespace Drupal\tbo_adminmenu_hn\Plugin\Block;
...
/**
 * Provides a 'MenuAdminEmpresaHnBlock' block.
 *
 * @Block(
 *  id = "menu_admin_empresa_hn_block",
 *  admin_label = @Translation("Menu Administrador Empresa HN"),
 * )
 */
class MenuAdminEmpresaHnBlock extends CardBlockBase {
	...
	public function blockSubmit($form, FormStateInterface $form_state) {	
  	...
  	public function build() {
	    ...
	    $build['#data']['companie_user'] = $companie_user;
        ...
        'library' => array('tbo_adminmenu_hn/admin-empresa-menu',
	        )
	    );
	    return $build;  
	}
