...
use Drupal\tbo_billing_hn\Plugin\Config\Block\BillingSummaryHnBlockClass;
use Drupal\tbo_general\CardBlockBase;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'BillingSummaryHnBlock' block.
 *
 * @Block(
 *  id = "billing_summary_hn_block",
 *  admin_label = @Translation("Resumen de facturación HN"),
 * )
 */
class BillingSummaryHnBlock extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var \Drupal\tbo_billing\Plugin\Config\Block\BillingSummaryHnBlock
   */
   ...
   * @param \Drupal\tbo_billing_hn\Plugin\Config\Block\BillingSummaryHnBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, BillingSummaryHnBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing_hn.billing_summary_hn_block_class')
    );
  }
