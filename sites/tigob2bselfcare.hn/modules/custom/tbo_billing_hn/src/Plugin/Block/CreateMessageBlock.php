...
use Drupal\tbo_billing_hn\Plugin\Config\Block\CreateMessageBlockClass;
use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'CreateMessageBlock' block.
 *
 * @Block(
 *  id = "create_message_block",
 *  admin_label = @Translation("Create Message"),
 * )
 */
class CreateMessageBlock extends CardBlockBase implements ContainerFactoryPluginInterface {


  /**
   * @var CreateMessageBlockClass
   */
   ...
   * @param \Drupal\tbo_billing_hn\Plugin\Config\Block\CreateMessageBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, CreateMessageBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing_hn.create_message_block')
    );
  }
