...
use Drupal\tbo_billing_hn\Plugin\Config\ServicePortfolioHnBlockClass;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Drupal\tbo_billing\Plugin\Block\ServicePortfolioBlock;

/**
 * Provides a 'ServicePortfolioHnBlock' block.
 *
 * @Block(
 *  id = "service_portfolio_hn_block",
 *  admin_label = @Translation("Servicios Portafolio HN"),
 * )
 */
class ServicePortfolioHnBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
    /*
     ...
     * @param \Drupal\tbo_billing\Plugin\Config\ServicePortfolioBlockClass $configurationInstance
     */
    
    public function __construct(array $configuration, $plugin_id, $plugin_definition, ServicePortfolioHnBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_billing_hn.service_portfolio_hn_block')
    );
  }
