...
use Drupal\tbo_billing_hn\Plugin\Block\BillingSummaryHnBlock;
use Drupal\Core\Session\AccountInterface;
use Drupal\Core\Access\AccessResult;

/**
 * Manage config a 'BillingSummaryHnBlockClass' block.
 */
class BillingSummaryHnBlockClass {
  protected $instance;
  protected $configuration;

  /**
   * @param \Drupal\tbo_billing_hn\Plugin\Block\BillingSummaryHnBlock $instance
   * @param $config
   */
  public function setConfig(BillingSummaryHnBlock &$instance, &$config) {
   ...
   * {@inheritdoc}
   */
  public function build(BillingSummaryHnBlock &$instance, $configuration) {
...
/*
  ...
  */
    ...
    $display = 'no-services'; //added RVS 20180218
