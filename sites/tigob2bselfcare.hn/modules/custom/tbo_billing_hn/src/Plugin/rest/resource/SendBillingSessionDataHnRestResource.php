 ...
 *
 * @RestResource(
 *   id = "send_billing_session_data_hn_rest_resource",
 *   label = @Translation("Send billing session data rest resource HN"),
 *   uri_paths = {
 *     "canonical" = "/billing/session/data/hn"
 *   }
 * )
 */
class SendBillingSessionDataHnRestResource extends SendBillingSessionDataRestResource {
  ...
  public function saveAuditLog() {
    ...
    $log->set('details', 'Usuario ' . $name . ' consultó detalle de factura ');
    $log->save();
  }
