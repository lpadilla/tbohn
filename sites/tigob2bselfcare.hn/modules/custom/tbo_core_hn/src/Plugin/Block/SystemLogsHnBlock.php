...
namespace Drupal\tbo_core_hn\Plugin\Block;

use Drupal\Core\Form\FormStateInterface;
use Drupal\Core\Session\AccountInterface;
use Drupal\tbo_general\CardBlockBase;
use Drupal\tbo_core_hn\Plugin\Config\Block\SystemLogsHnBlockClass;
use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'SystemLogsHnBlock' block.
 *
 * @Block(
 *  id = "system_logs_block_hn",
 *  admin_label = @Translation("List of logs of HN"),
 * )
 */
class SystemLogsHnBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
   ...
   * @param \Drupal\tbo_core_hn\Plugin\Config\Block\SystemLogsHnBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, SystemLogsHnBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_core_hn.system_logs_block_hn')
    );
  }
