...
namespace Drupal\tbo_core_hn\Plugin\Config\Block;
use Drupal\tbo_core_hn\Plugin\Block\SystemLogsHnBlock;
...
use Drupal\tbo_core;
/**
 * Manage config a 'SystemLogsHnBlockClass' block.
 */
class SystemLogsHnBlockClass extends SystemLogsBlockClass {
  protected $instance;
  protected $configuration;

  /**
   * @param \Drupal\tbo_core_hn\Plugin\Block\SystemLogsHnBlock $instance
   * @param $config
   */
  public function setConfig(SystemLogsHnBlock &$instance, &$config) {
    ...
    return [
      'filters_options' => [
        'filters_fields' => [
          ...
          'company_name' => ['title' => t("Empresa y/o Cliente"), 'label' => 'Empresa', 'service_field' => 'company_name', 'show' => 1, 'weight' => 1, 'class' => '3-columns', 'validate_length' => '200'],          
          'user_names' => ['title' => t("Nombre"), 'label' => 'Nombre', 'service_field' => 'user_names', 'show' => 1, 'weight' => 2, 'class' => '3-columns', 'validate_length' => '300'],
          'company_document_number' => ['title' => t("Número de documento"),'label' => 'Número de documento', 'service_field' => 'company_document_number', 'show' => 1, 'weight' => 3, 'input_type' => 'text', 'class' => '3-columns', 'validations' => 'maxlength=300'],
          'company_segment' => ['title' => t("Segmento"), 'label' => 'Segmentos', 'service_field' => 'company_segment', 'show' => 1, 'weight' => 4, 'class' => '3-columns', 'validate_length' => '130'],
          'created' => ['title' => t("Fecha"), 'label' => 'Fecha', 'service_field' => 'created', 'show' => 1, 'weight' => 5, 'class' => '5-columns'],
          'description' => ['title' => t("Descripcion"), 'label' => 'Descripcion', 'service_field' => 'description', 'show' => 1, 'weight' => 6, 'class' => '3-columns', 'validate_length' => '300'],
          'details' => ['title' => t("Detalles"), 'label' => 'Detalles', 'service_field' => 'details', 'show' => 1, 'weight' => 7, 'class' => '3-columns', 'validate_length' => '350'],
          'user_role' => ['title' => t("Tipo"), 'label' => 'Tipo', 'service_field' => 'user_role', 'show' => 1, 'weight' => 8, 'class' => '3-columns'],         
      ...
      'table_options' => [
        'table_fields' => [
          'user_names' => ['title' => t("Nombre"), 'label' => 'Nombre', 'service_field' => 'user_names', 'show' => 1, 'weight' => 1,'class' => ''],
          'user_role' => ['title' => t("Tipo de usuario"), 'label' => 'Tipo de usuario', 'service_field' => 'user_role', 'show' => 1, 'weight' => 2,'class' => ''],
          'company_name' => ['title' => t("Empresa/Cliente"), 'label' => 'Empresa/Cliente', 'service_field' => 'company_name', 'show' => 1, 'weight' => 3,'class' => ''],
          'company_document_number' => ['title' => t("RTN"), 'label' => 'RTN', 'service_field' => 'company_document_number', 'show' => 1, 'weight' => 4,'class' => ''],
          'company_segment' => ['title' => t("Segmento"), 'label' => 'Segmento', 'service_field' => 'company_segment', 'show' => 1, 'weight' => 5,'class' => ''],
          'created' => ['title' => t("Fecha"), 'label' => 'Fecha', 'service_field' => 'created', 'show' => 1, 'weight' => 6,'class' => ''],             
          'event_type' => ['title' => t("Tipo"), 'label' => 'Tipo', 'service_field' => 'event_type', 'show' => 1, 'weight' => 6,'class' => ''],
          'description' => ['title' => t("Descripción"), 'label' => 'Descripción', 'service_field' => 'description', 'show' => 1, 'weight' => 7,'class' => ''],
          'details' => ['title' => t("Detalles"), 'label' => 'Detalles', 'service_field' => 'details', 'show' => 1, 'weight' => 8,'class' => ''],
          'old_values' => ['title' => t("Anterior"), 'label' => 'Anterior', 'service_field' => 'old_values', 'show' => 1, 'weight' => 9,'class' => ''],
          'new_values' => ['title' => t("Nuevo"), 'label' => 'Nuevo', 'service_field' => 'new_values', 'show' => 1, 'weight' => 10,'class' => ''],
        ],
      ],
      'others' => [
        'config' => [
  ...
  public function blockForm($form, FormStateInterface $form_state)  {
    ...
    $form['options_date'] = [
      ...
      '#default_value' => $this->configuration['options_date'],
      '#size' => 5,
      '#maxlength' => 5,
    ];
     
    $form = $this->instance->cardBlockForm($form);
    return $form;
  }
  /**
   * {@inheritdoc}
   ...
   * {@inheritdoc}
   */
  public function build(SystemLogsHnBlock &$instance, &$config) {
    ...
    foreach ($user_roles as $key => $value) {
      ...
      elseif ($value == 'super_admin') {
        ...
        $roles = ['super_admin' => 'Super Admin', 'tigo_admin' => 'Tigo Admin', 'admin_company' => 'Admin Empresa'];
      }
      elseif ($value == 'tigo_admin') {
        //$roles = ['tigo_admin' => 'Tigo Admin', 'admin_company' => 'Admin Empresa', 'admin_grupo' => 'Admin Grupo'];
        $roles = ['tigo_admin' => 'Tigo Admin', 'admin_company' => 'Admin Empresa'];
      }
    }
