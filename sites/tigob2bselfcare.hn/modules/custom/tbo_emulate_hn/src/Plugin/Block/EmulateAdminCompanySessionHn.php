...
use Drupal\tbo_emulate_hn\Plugin\Config\Block\EmulateAdminCompanySessionHnBlockClass;
use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a 'EmulateAdminCompanySession' block.
 *
 * @Block(
 *  id = "emulate_admin_company_session_hn_hn",
 *  admin_label = @Translation("Emulate Admin Company Session HN"),
 * )
 */
class EmulateAdminCompanySessionHn extends CardBlockBase implements ContainerFactoryPluginInterface {

  /**
   * @var EmulateAdminCompanySessionBlockClass
   */
   ...
   * @param \Drupal\tbo_emulate_hn\Plugin\Config\Block\EmulateAdminCompanySessionHnBlockClass $configurationInstance
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, EmulateAdminCompanySessionHnBlockClass $configurationInstance) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('tbo_emulate_hn.emulate_admin_company_session_hn_block')
    );
  }
