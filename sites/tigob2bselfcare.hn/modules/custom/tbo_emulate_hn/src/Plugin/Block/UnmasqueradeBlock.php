...
use Drupal\tbo_emulate_hn\Plugin\Config\Block\UnmasqueradeBlockClass;
 ...
 *
 * @Block(
 *  id = "unmasquerade_block_hn",
 *  admin_label = @Translation("Desenmascarar sesion HN"),
 * )
 */
class UnmasqueradeBlock extends CardBlockBase implements ContainerFactoryPluginInterface {
   ...
   * @param Drupal\tbo_emulate_hn\Plugin\Config\Block\UnmasqueradeBlockClass $configurationInstance
   */
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      //$container->get('tbo_user.unmasquerade_block')
      $container->get('tbo_emulate_hn.unmasquerade_hn_block')
    );
  }
