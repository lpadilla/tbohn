...
use Drupal\tbo_emulate_hn\Plugin\Block\EmulateAdminCompanySessionHn;
use Drupal\Core\Session\AccountInterface;
use Drupal\Core\Access\AccessResult;
use Drupal\Core\Form\FormStateInterface;

/**
 * Manage config a 'EmulateAdminCompanySessionHnBlockClass' block.
 */
class EmulateAdminCompanySessionHnBlockClass {
  protected $instance;
  protected $configuration;

  /**
   * @param \Drupal\tbo_emulate_hn\Plugin\Block\EmulateAdminCompanySessionHn $instance
   * @param $config
   */
  public function setConfig(EmulateAdminCompanySessionHn &$instance, &$config) {
   ...
   * {@inheritdoc}
   */
  public function build(EmulateAdminCompanySessionHn &$instance, &$config) {
    ...
    $parameters = [
      'theme' => 'emulate_session_hn',
      'library' => 'tbo_emulate_hn/emulate-session',      
    ];
    ...
    $config_block = $this->instance->cardBuildConfigBlock('/tboapi/emulate/hn/session?_format=json');
