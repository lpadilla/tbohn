...
namespace Drupal\tbo_entities_hn\Entity;
 ...
 * )
 */
class CompanyEntityHn extends CompanyEntity implements CompanyEntityInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
     ...
     */
      ...
      $fields['company_code'] = BaseFieldDefinition::create('string')
       ->setLabel(t('Código de Empresa'))
       ->setDescription(t('Código de Empresa.'))
       ->setSettings(array(
           'max_length' => 150,
           'text_processing' => 0,
        ))
