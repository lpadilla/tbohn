...
(function ($) {
    ...
    // on-off los label de los formularios /gestion-usuarios y /usuarios
    Drupal.behaviors.activeForm = {
        attach: function (context) {
            if($('form.create-user #tagsList').length > 0){
                $('form.create-user #tagsList #suggestions').bind('click', function(e) {
                    $('form.create-user #tagsList label').addClass('active');
    ...
    Drupal.behaviors.menu_tabs = {
        attach: function (context) {
            ...
            if($('.transactionCategoryBlock').length > 0){
                $(".tab_content").hide();
                $(".tab_content:first").show();
                $(".transactionCategoryBlock ul li").click(function() {
                    $(".tab_content").hide();
